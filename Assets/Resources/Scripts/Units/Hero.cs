...
public abstract class Hero : Unit
{
    ...
    public Hero(string unitName, string spriteName, MetaInformation metaInformation, Stats baseStats, List<HeroClass> heroClasses) : base(unitName, spriteName, metaInformation, baseStats, TypeClass.HERO)
    {
